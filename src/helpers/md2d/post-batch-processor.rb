...
class MD2DImports
  ...
  def initialize()
    ...
    Dir.chdir(@path) do
      ...
      @model_list.push(MD2DDirectory.new("public/part1/chempot").section)
      @model_list.push(MD2DDirectory.new("public/part1/conduction").section)
      @model_list.push(MD2DDirectory.new("public/part1/conserve").section)
      @model_list.push(MD2DDirectory.new("public/part1/distillation").section)
      @model_list.push(MD2DDirectory.new("public/part1/elisa").section)
      @model_list.push(MD2DDirectory.new("public/part1/emove").section)
      @model_list.push(MD2DDirectory.new("public/part1/energy").section)
      @model_list.push(MD2DDirectory.new("public/part1/fluorescence").section)
      @model_list.push(MD2DDirectory.new("public/part1/heatflow").section)
      @model_list.push(MD2DDirectory.new("public/part1/insulin").section)
      @model_list.push(MD2DDirectory.new("public/part1/protein").section)
      @model_list.push(MD2DDirectory.new("public/part1/redox").section)
