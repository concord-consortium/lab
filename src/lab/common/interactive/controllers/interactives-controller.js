...
define(function (require) {
  // Dependencies.
  var BarGraphController      = require('common/interactive/controllers/bar-graph-controller'),
      GraphController         = require('common/interactive/controllers/graph-controller'),
      DgExportController      = require('common/interactive/controllers/dg-export-controller'),
      ScriptingAPI            = require('common/interactive/controllers/scripting-api'),
      ButtonController        = require('common/interactive/controllers/button-controller'),
      CheckboxController      = require('common/interactive/controllers/checkbox-controller'),
      RadioController         = require('common/interactive/controllers/radio-controller'),
      SliderController        = require('common/interactive/controllers/slider-controller'),
      PulldownController      = require('common/interactive/controllers/pulldown-controller'),
      NumericOutputController = require('common/interactive/controllers/numeric-output-controller'),
      ParentMessageAPI        = require('common/interactive/controllers/parent-message-api'),
      ThermometerController   = require('common/interactive/controllers/thermometer-controller'),
