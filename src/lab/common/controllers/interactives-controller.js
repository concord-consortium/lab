...
import $__models_sensor_controller from 'models/sensor/controller';
import $__models_dual_sensor_controller from 'models/dual-sensor/controller';
import $__models_dual_sensor_connector_controller from 'models/dual-sensor-connector/controller';
...
var labConfig = $__lab_config,
  ...
  ModelControllerFor = {
    ...
    'iframe-model': $__models_iframe_controller,
    'sensor': $__models_sensor_controller,
    'dual-sensor': $__models_dual_sensor_controller,
    'dual-sensor-connector': $__models_dual_sensor_connector_controller,
    'sensor-connector': $__models_sensor_connector_controller,
...
export default function InteractivesController(interactiveReference, viewSelector) {
  ...
  function generateRandomSeed() {
    ...
    Math.seedrandom = seedrandom(randSeed);
  }
  ...
  */
  ...
  function getBoundProperties() {
    ...
    var graphProperties = _.pluck(_.where(interactive.components, {
      type: 'graph'
    }), 'properties');
  ...
  function getDefaultExports() {
    ...
    if (model && model.properties.type === 'md2d') {
      additionalPerTickProperties =
        model.properties.unitsScheme === 'md2d' ? ['kineticEnergy', 'potentialEnergy', 'temperature'] : ['kineticEnergy', 'potentialEnergy'];
    }
