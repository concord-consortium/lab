...
define(function (require) {
  ...
  */
  (function(d, s, id) {
    ...
    if(typeof fjs === 'undefined') return;
  ...
  *  Embeds tweet button
  */
  window.twttr=(function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],t=window.twttr||{};if(typeof fjs === 'undefined') return;if(d.getElementById(id))return;js=d.createElement(s);js.id=id;js.src="https://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);t._e=[];t.ready=function(f){t._e.push(f);};return t;}(document,"script","twitter-wjs"));
  /**
  *  Embeds the Google+ share button
  */
  (function() { var po = document.createElement('script'); po.type = 'text/javascript'; po.async = true; po.src = 'https://apis.google.com/js/plusone.js'; var s = document.getElementsByTagName('script')[0];if(typeof s === 'undefined')return; s.parentNode.insertBefore(po, s); })();
