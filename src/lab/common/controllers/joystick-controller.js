...
export default function JoystickController(component, interactivesController) {
  ...
  function initialize() {
    ...
    if (propertyName === undefined && initialValue === undefined) initialValue = {
      magnitude: 0,
      direction: 0
    };
  ...
  controller = {
    ...
    resize: function(fromSetup) {
      ...
      $labelE.css({
        left: centerX + baseSize / 2 + 0.1 * emSize
      });
      $labelW.css({
        left: centerX - baseSize / 2 - 0.1 * emSize - $labelW[0].clientWidth
      });
      $labelN.css({
        left: centerX - $labelN.outerWidth(true) / 2
      });
      $labelS.css({
        left: centerX - $labelS.outerWidth(true) / 2
      });
      ...
      $joystickHandle.css({
        ...
        width: handleSize,
        borderRadius: baseSize,
        left: baseSize / 2 - handleSize / 2,
        top: baseSize / 2 - handleSize / 2
      });
