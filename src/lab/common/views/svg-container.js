...
define(function (require) {
  ...
  return function SVGContainer(model, modelUrl, Renderer, opt) {
    ...
    function init() {
      ...
      // Shutterbug event loop (remember synthetic events such as 'shutterbug-saycheese' are handled
      // synchronously) the rendered image will still be in the WebGL drawing buffer where
