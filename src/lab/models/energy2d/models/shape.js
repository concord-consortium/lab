...
// - polygonize()
// - contains(x, y)
export const Polygon = function(count, x_coords, y_coords, x, y) {
  this.count = count;
...
// - polygonize()
// - contains(x, y)
export const Rectangle = function(x, y, width, height) {
  this.x = x;
  this.y = y;
  this.width = width;
  this.height = height;
...
// - polygonize()
// - contains(x, y)
export const Ellipse = function(x, y, a, b) {
  this.x = x;
  this.y = y;
  this.a = a;
  this.b = b;
...
// - polygonize()
// - contains(x, y)
export const Ring = function(x, y, inner, outer) {
  this.x = x;
  this.y = y;
  this.inner = inner;
  this.outer = outer;
