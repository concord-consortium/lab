  ...
  exports.createEngine = function() {
    ...
    engine = {
      ...
      setTemperatureOfAtoms: function(atomIndices, targetT) {
        ...
        var i, j, vxtmp, vytmp, scale, s, groupT,
      ...
      */
      ...
      integrate: function(duration, _dt) {
        ...
        for (iloop = 1; iloop <= steps; iloop++) {
          ...
          pluginController.callPluginFunction("performActionWithinIntegrationLoop", {neighborList: neighborList, dt: dt});
