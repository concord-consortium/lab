...
define(function (require) {
  ...
  return function PTAView(modelView, model) {
  // return function PTAView(model, containers, m2px, m2pxInv, mSize2px) {
    ...
    */
    ...
    function init() {
      ...
      model.on('addTurtle', redrawClickableObjects(repaint));
      model.on('removeTurtle', redrawClickableObjects(repaint));
    }
