...
define(function(require) {
  ...
  return function UnitsTranslation(unitsDefinition) {
    ...
    var // multiply PTA-units value by this to get the value in SI units
        siFactor = {},

        // multiply PTA-units value by this to get the value in translated (macroscopic) units
        factor = {},
        ...
        _.each(baseUnitTypes, function (unitType) {
          ...
          siFactor[unitType] = u.valueInSIUnits / u.representationInPTAUnits;
        });
      ...
      return {
        translateToPTAUnits: function(translatedUnitsValue, unitType) {
        ...
        translateFromPTAUnits: function(md2dUnitsValue, unitType) {
          if (factor[unitType] == null) {
            return ptaUnitsValue;
          }
          return ptaUnitsValue * factor[unitType];
        }
      };
   };
});
