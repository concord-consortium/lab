...
globals [
  ...
  data-not-saved?   ; true when data have been collected but not yet saved
  old-x-center
  old-y-center
  old-magnification
  old-vehicle-loc
...
to save-for-output
  ...
  ask vehicle (first v-who) [  ; this version only suports one vehicle
    ...
    update-data-series point  ; save for later JSON data:export features
    set data-not-saved? true
...
198
395
\"Ramp-Friction\" sets the friction to the left of zero. 
10
0.0
1
