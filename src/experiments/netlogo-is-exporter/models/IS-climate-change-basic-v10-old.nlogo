...
; Uses the old data export strategy
...
to show-start-screen
  ...
  create-dots 1 [
    ...
    set label-color white
    set size .1
    set label "But you cannot analyze data after you 'mess around'."]
  create-dots 1 [
    setxy 20 0 
    set label-color white
    set size .1
  ...
  create-dots 1 [
   ...
   create-dots 1 [
    ...
    set label-color white
    set size .1
    set label "When you reach the end of your run, you can analyze your data in Data Games."]
...
to initialize
  ...
  create-messages 1 [
    ...
    set mess1 who ]
  create-messages 1 [
    set label "Ready to analyze data in DataGames"
    set mess2 who ]
  create-messages 1 [
    set label "Messing around: sliders unlocked"
    set mess3 who ]
  create-messages 1 [
    set label "Messing around: data analysis disabled"
    set mess4 who ]
  ask messages [
    ht set size .1
...
to-report preamble-maker; generates a list of lists of name, value pairs. 
  ...
  let output (list list "collection_name" "IS Climate Model v10-old")
  set output lput list "Final Temperature" precision smooth-temperature 2 output
  set output lput list "CO2 amount" CO2-level output
  set output lput list "Albedo" albedo output
  set output lput list "Clouds" cloud-amount output
