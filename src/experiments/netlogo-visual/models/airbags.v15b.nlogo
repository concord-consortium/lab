...
to run-airbag ; computes and draws the position or velocity graphs of the airbag and dummy 
  ...
  let samples 100  ; initialize number of samples during collection
  let dt experiment-duration-in-sec / samples        ; results in 100 points, which seems continuous
