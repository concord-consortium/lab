...
PROJECT_LIST = {
  ...
  'framework'      => { :repository => 'git://github.com/concord-consortium/framework.git',
                        :branch => 'trunk',
  ...
  'data'           => { :repository => 'git://github.com/concord-consortium/data.git',
                        :branch => 'trunk',
  ...
  'sensor'         => { :repository => 'git://github.com/concord-consortium/sensor.git',
  ...
  'sensor-applets' => { :repository => 'git://github.com/concord-consortium/sensor-applets.git',
                        :branch => 'master',
  ...
  'sensor-native'  => { :repository => 'git://github.com/concord-consortium/sensor-native.git',
  ...
  'frameworkview'  => { :repository => 'git://github.com/concord-consortium/frameworkview.git',
                        :branch => 'trunk',
  ...
  'mw'             => { :repository => 'git://github.com/concord-consortium/mw.git',
                        :branch => 'trunk',
