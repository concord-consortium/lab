...
Model steps/s measured over 100 model steps iterations. Tested on a MacBook Pro, 10.6.7, 2.66 GHz Intel Core i7.

With all rendering off:

|_.                        |_. Typed Arrays   |_. Regular Arrays |
| Chrome 14.0.788.0 canary |             27.1 |             11.1 |

With all rendering on:
