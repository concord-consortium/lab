...
const GeneticEngine = requirejs('models/md2d/models/engine/genetic-engine');
const Model         = requirejs('models/md2d/models/modeler');

describe("GeneticEngine", () => describe("[basic tests of the class]", function() {
  describe("GeneticEngine constructor", function() {
    it("should exist", () => should.exist(GeneticEngine));
