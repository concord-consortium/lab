...
const Dispatch = requirejs('common/dispatch-support');

describe("Dispatch", function() {
  describe("Dispatch constructor", () => it("should exist", () => should.exist(Dispatch)));

  return describe("instance of Dispatch", function() {
    ...
    it("should work as d3.dispatch unless batch mode is turned on", function() {
      ...
      return l.l2.getCall(2).args.should.eql([1, 2, "test", 3]);
  });
    ...
    it("should support 'batch mode'", function() {
      ...
      l.l1.callCount.should.eql(2);
      return l.l2.callCount.should.eql(1);
    });
    ...
    it("should support let user to manually flush all batched event even while in batch mode", function() {
      ...
      d.e2();
      d.endBatch();
      return l.l2.callCount.should.eql(5);
    });
    ...
    it("should let client code suppress event dsipatching", function() {
      ...
      l.l1.callCount.should.eql(0);
      return l.l2.callCount.should.eql(0);
    });
    ...
    return it("should provide mixInto method injecting .on() and .suppressEvents() methods to target", function() {
      const target = {};
      d.mixInto(target);

      should.exist(target.on);
      return should.exist(target.suppressEvents);
    });
  });
});