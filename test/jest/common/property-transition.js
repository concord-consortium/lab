import PropertyTransition from "../../../src/lab/common/models/property-transition";
import inherit from "../../../src/lab/common/inherit";
...
describe("PropertyTransition", function () {
  ...
  describe("instance of AbstractTransiton subclass", function () {
    ...
    it("should ignore any subsequent calls of process method", function () {
      t.process(300);
      t.isFinished.should.be.true;
      model[0].x.should.eql(10);
    });
