import StateManager from "../../../src/lab/common/views/state-manager";
...
describe("StateManager", function () {
  ...
  describe("instance of StateManager", function () {
    ...
    it("should evaluate all functions in state during getState() operation", function () {
      const test = 2;
      const state = {
        atom: [{
          y() {
