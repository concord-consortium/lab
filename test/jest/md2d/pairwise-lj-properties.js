import PairwiseLJProperties from "../../../src/lab/models/md2d/models/engine/pairwise-lj-properties";
...
describe("PairwiseLJProperties", function () {
  describe("[basic tests of the class]", function () {
    ...
    describe("PairwiseLJProperties constructor", function () {
      ...
      it("should act as a constructor that accepts the engine object", function () {
        const ljPropsCollection = new PairwiseLJProperties(engine);
        should.exist(ljPropsCollection);
      });
    });

    describe("PairwiseLJProperties instance", function () {
      let ljPropsCollection = null;

      beforeAll(() => ljPropsCollection = new PairwiseLJProperties(engine));
      ...
      describe("with registered change hooks", function () {
        ...
        it("should provide Clone-Restore interface", function () {
  ...
  describe("[tests in the MD2D modeler context]", () => {
    describe("PairwiseLJProperties instance", function () {
      ...
      it("should be filled with initial properties if they are defined in model JSON", function () {
        const model = new Model({
