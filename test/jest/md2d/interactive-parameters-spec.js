...
describe("Lab interactives: custom model parameters", () => {
  describe("interactives controller", function () {
    ...
    describe("overriding of custom parameter defined in interactive", function () {
      ...
      describe("when there are two models in the model section", function () {
        describe("and the default model has no model-specific custom parameter", function () {
          ...
          describe("and loadModel is used to load a model with a model-specific custom parameter", function () {
            beforeEach(function () {
        ...
        describe("and the default model has a model-specific custom parameter", function () {
          beforeEach(function () {
            interactive.models[0].parameters = baseParameters.slice().concat(parameter2);
            helpers.withModel(simpleModel, () => controller = new InteractivesController(interactive, "body"));
            model = controller.getModel();
          ...
          describe("and loadModel is used to load a model without a model-specific custom parameter", function () {
            beforeEach(function () {
              helpers.withModel(simpleModel, () => controller.loadModel("model2"));
              model = controller.getModel();
            });
