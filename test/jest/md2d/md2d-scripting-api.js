...
describe("MD2D Scripting API test", function () {
  beforeAll(function () {
  ...
  describe("atomsWithinTriangle", function () {
    beforeAll(() => loadModel({width: 10, height: 10}));

    it("should return atoms within triangular area", function () {
  ...
  describe("addKEToAtoms", function () {
    beforeAll(() => loadModel({width: 10, height: 10}));

    const err = 1e-4;

    it("should add given amout of KE to group of atoms", function () {
