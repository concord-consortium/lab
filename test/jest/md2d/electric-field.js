...
describe("MD2D modeler", function() {
  ...
  describe("when addElectricField() is called", function() {
    ...
    it("should trigger 'addElectricField' event", function() {
  ...
  describe("when setElectricFieldProperties() is called", function() {
    ...
    it("should trigger 'changeElectricField' event", function() {
      const callback = sinon.spy();
  ...
  describe("when removeElectricField() is called", function() {
    ...
    beforeEach(function() {
      ...
      model.addElectricField({intensity: 3, orientation: "E"});
    }); // idx = 2
    ...
    describe("and provided index matches some electric field", function() {
      ...
      it("should trigger 'removeElectricField' event", function() {
        const callback = sinon.spy();
    ...
    describe("and provided index doesn't match any electric field", () => { it("should fail and report an error", function() {
  ...
  describe("when shape with electric field is removed", function() {
      ...
      beforeEach(function() {
        ...
        model.addElectricField({intensity: 3, orientation: "E", shapeIdx: null});
      }); // idx = 2
      ...
      it("should also trigger 'removeElectricField' event", function() {
        const callback = sinon.spy();
        model.on('removeElectricField', callback);
