...
describe("MD2D modeler", function () {
  ...
  describe("when addAtom() is called", function () {
    describe("and the properties are correct", function () {
      ...
      it("should trigger 'addAtom' event", function () {
  ...
  describe("when removeAtom() is called", function () {

    beforeEach(function () {
      model.addAtom({x: 1, y: 1}); // idx = 0
      model.addAtom({x: 2, y: 2}); // idx = 1
      model.addAtom({x: 3, y: 3});
    }); // idx = 2
    ...
    describe("and provided index matches some atom", function () {
      ...
      describe("and there are connected radial bonds", function () {
        ...
        describe("and there are connected angular bonds", function () {
          ...
          it("should also trigger 'removeAngularBond' event", function () {
            const callback = sinon.spy();
        ...
        it("should trigger 'removeRadialBond' event if some radial bonds are removed", function () {
          const callback = sinon.spy();
          model.on("removeRadialBond", callback);
