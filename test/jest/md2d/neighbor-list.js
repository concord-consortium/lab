import NeighborList from "../../../src/lab/models/md2d/models/engine/neighbor-list";
...
describe("Neighbor List", function () {
  ...
  describe("when neighborhood between atoms is defined", function () {
    beforeEach(function () {
    ...
    describe("and positions of atoms are set", function () {
      ...
      it("should be updated after invalidation", function () {
        neighborList.shouldUpdate(xcoords, ycoords).should.equal(true);
        neighborList.shouldUpdate(xcoords, ycoords).should.equal(false);
    ...
    describe("but list is cleared", function () {
      beforeEach(() => neighborList.clear());

      it("should work correctly after clearing", function () {
